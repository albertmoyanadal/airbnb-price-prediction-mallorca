...
%
%  NOTE
%  The final pdf requires the official cover available at : https://cep.uib.es/es/impresos/#IMP_TFM
%
%

\title{Títol Provisional del TFM}

\author{\normalsize 
{\large Albert Moya Nadal} \\
 \textbf{Tutor:}  {\large Miquel Miró Nicolau i Biel Moyà Alcover} \\
Treball de fi de Màster Universitari en Anàlitica de Dades i Intel·ligència de Negoci (MAD2)\\
Universitat de les Illes Balears \\
07122 Palma de Mallorca \\
\url{albert.moya1@estudiant.uib.cat}
}
% 
% % % % % % % % % % % % % % % % % %
...
\hyphenation{pa-la-bra sa-li-da}
...
% % % % % % % % % % % % % % % % % %
\begin{abstract}
\noindent Esta plantilla usa el estilo de ``Normas de edición de las Jenui'' realizado por Joe Mirò Julìa y Mercedes Marqués. Modificada para su uso en el TFM del MADM por Isaac Lera.

\end{abstract}

\section*{Abstract}
\noindent  This template is based on the predefined style of ``Normas de edición de las Jenui'' by Joe Mirò Julìa and Mercedes Marqués''. Adaptation to the TFM (MADM) is done by Isaac Lera.\par
...
Estas normas son de obligado cumplimiento para todos los alumnos del trabajo de fin de máster. 
 No cumplir estas normas puede llevar a la no aceptación o a la no 
...
Si hay más de un autor puede organizarse su información en columnas, 
tal y como está en este documento. Pero hay restricciones en el uso 
de columnas que deben observarse.
\begin{itemize}
	\item Sólo pueden usarse columnas si las filiaciones son 
	diferentes. Si todos los autores son de la misma filiación deben 
	separarse sus nombres por comas y usar una única dirrección.
	
	\item Se desaconseja el uso de 3 columnas y se prohibe el uso de 
	más de 3 columnas. Si los autores son de más de 3 filiaciones 
	diferentes deben usarse superíndices, como se muestra en la 
	Figura~\ref{fig:tit}.
\end{itemize}

\begin{figure*}
	\begin{center}
		\includegraphics[scale = 0.6]{figures/titulo.pdf}
	\end{center}
	\caption{\label{fig:tit} Ejemplo de título usando superíndices}
\end{figure*}
...
\begin{figure}
\begin{center}
	\includegraphics[width = \linewidth]{figures/mediaref.pdf}
\end{center}
...
\begin{figure*}
	\begin{center}
	\includegraphics[width = 0.8\linewidth]{figures/diagrLargo.jpg}
	\end{center}
...
Excepto en muy raras ocasiones, un documento acaba con 
...
El formato de la bibliografía casi merece un artículo propio. Si se 
usa un programa bibliográfico como, o EndNote no es necesario 
preocuparse de mucho. Si en cambio se crea la bibliografía a mano 
...
\begin{itemize}
	...
	otra fuente (o se usa) es posible que se importen palabras
	en inglés (``J. García \emph{and} P. Quintero, \emph{editors}'').
	Debe cambiarse al español\footnote{Usuarios de  editad el
	archivo .bbl justo antes de la última compilación.}.
...
Ejemplos de citación de referencias:~\cite{Hennessy2011,MARS} o simplemente~\cite{Kane}
\section{Conclusiones}

El documento con el que estás trabajando ahora 
...
\section{Uso de apéndices}
Es recomendable el uso de apéndices cuando se pretende aclarar una parte del trabajo paralela a la principal línea argumental, por ejemplo: la configuración de una determinada herramienta, la puesta a punto de un entorno, los resultados secundarios de un experimento, etc.

\section{Otro ejemplo de apéndice}
En la documentación no es recomendable el uso excesivo de apéndices.



\bibliographystyle{plain}
\bibliography{bibliografia} %Update in your case
